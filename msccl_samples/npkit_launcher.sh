...
# export NPKIT_FLAGS="-DENABLE_NPKIT_GPU_EVENTS"
# export NPKIT_FLAGS="-DENABLE_NPKIT_CPU_EVENTS"
export NPKIT_FLAGS="-DENABLE_NPKIT_GPU_EVENTS -DENABLE_NPKIT_CPU_EVENTS"
